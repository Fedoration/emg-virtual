...
class Hand:
    ...
    finger_start_pose = {
        "thumb": np.array([1.79773151e-04, -9.56848596e-05, 1.40103373e-04]),
    ...
    def visualize_all_frames(self):
        ...
        anim = animation.FuncAnimation(
            fig, animate, interval=1, frames=len(self), repeat=True
        )
...
def visualize_val_moves(
    model, val_exps_data, epoch, device, window_size=256, pred_fps=200
):
    old_fps = 200
    new_fps = 25
